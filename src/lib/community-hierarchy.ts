...
const shopListCard: FullCard = {
  ...
  teachingAids: ["نموذج قائمة", "صور أقسام المتجر"],
...
const pickProductCard: FullCard = {
  ...
  teachingAids: ["صورة القسم", "بطاقة مقارنة سعر"],
...
const reviewInvoiceCard: FullCard = {
  ...
  teachingAids: ["نموذج فاتورة موضحة", "بطاقة أرقام"],
...
const taxiCard: FullCard = {
  ...
  teachingAids: ["دليل مصور للتطبيق", "بطاقة رقم طوارئ"],
...
const clinicCheckinCard: FullCard = {
  ...
  teachingAids: ["بطاقة موعد", "بطاقة صور للاستقبال"],
...
const pharmacyCard: FullCard = {
  ...
  teachingAids: ["بطاقة أسئلة", "قائمة أدوية الأسرة"],
...
const submitDocCard: FullCard = {
  ...
  teachingAids: ["بطاقة صور للمركز", "قائمة مستندات مطلوبة"],
...
const restaurantCard: FullCard = {
  ...
  teachingAids: ["قائمة مصورة", "بطاقة عبارات مهذبة"],
...
const interviewFileCard: FullCard = {
  ...
  teachingAids: ["قائمة تحقق", "نموذج سيرة ذاتية مبسط"],
...
const emergencyHelpCard: FullCard = {
  ...
  teachingAids: ["بطاقة أرقام طوارئ", "بطاقة سيناريو مصور"],
