...
const SECTIONS: Section[] = [
  {
    ...
    body: "ينطلق دليلي للمشاركة الحياتية من قناعة بسيطة: يوم الأسرة ممتلئ أصلاً بالأحداث، والطفل أو الشاب حاضر في هذه الأحداث سواء شارك فيها أو لا. لذلك لا نطلب من الأسرة وقتاً إضافياً ولا جلسات منفصلة، بل نعيد النظر في الحدث القائم ونحوّله إلى فرصة مشاركة لها معنى.",
    points: [
      "لا أنشطة جديدة تُضاف إلى جدول الأسرة.",
      "لا فصل بين «وقت خاص» و«وقت الحياة».",
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-3 rounded-2xl border border-border/70 bg-secondary p-4 text-right">
        ...
        <p className="text-sm leading-relaxed text-foreground/90">
          هذه الاعتبارات إرشادات دعم أسرية عامة، وليست تشخيصاً ولا خطة متخصصة، وتُعدّل
          بحسب الشخص والسياق.
        </p>
      </div>
